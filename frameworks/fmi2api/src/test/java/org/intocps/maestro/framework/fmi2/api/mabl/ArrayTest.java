...
public class ArrayTest extends BaseApiTest{
    ...
    public void MDArrayFaultyAssignmentTest() throws Exception {
        ...
        builder.getDynamicScope().add(newAAssignmentStm(sharedDataDerivatives.items().get(0).getDesignatorClone(), val));
        ...
        //Assert
        Assertions.assertFalse(res, "Expected: Invalid assignment to cannot assign: 'real' to 'real[]'");
